...
UNION_ALPHABET = DIGITS | LETTERS | COMMA | SEMICOLON | COLON | EXCL_MARK | QUESTION_MARK | BACKSLASH | STAR | PLUS_SIGN | MINUS_SIGN | FORWARD_SLASH | OPEN_PARENTHESIS | CLOSE_PARENTHESIS | OPEN_BRACE | CLOSE_BRACE | OPEN_BRACKET | CLOSE_BRACKET | GREATER_THAN | LESS_THAN | EQUAL | PERIOD | QUOTE | DOUBLE_QUOTE | UNDERLINE | NL | TAB | SPACE | POWER | EOF
